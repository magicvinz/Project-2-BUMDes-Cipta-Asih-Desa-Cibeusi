...
@section('title', 'Tambah Produk Khas')
...
<h4 class="fs-4 fw-semibold mb-4">Tambah Produk Khas</h4>

<div class="row">
    <div class="col-lg-8">
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                <form action="{{ route('pengelola.produk-khas.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select name="id_wisata" id="id_wisata" class="form-select @error('id_wisata') is-invalid @enderror">
                            ...
                            @foreach($wisataList as $w)
                                <option value="{{ $w->id }}" {{ old('id_wisata') == $w->id ? 'selected' : '' }}>{{ $w->nama }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="urutan" id="urutan" value="{{ old('urutan', 0) }}" min="0" class="form-control @error('urutan') is-invalid @enderror">
